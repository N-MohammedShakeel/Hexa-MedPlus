  ...
  return (
    <div className="max-w-4xl mx-auto p-6 animate-fade-in">
      ...
      <Card padding="lg" className="border border-neutral-300 dark:border-slate-700 bg-white dark:bg-slate-900">
        ...
        <div className="border-2 border-dashed border-neutral-300 dark:border-slate-600 rounded-8 p-10 flex flex-col items-center justify-center bg-neutral-50 dark:bg-slate-800/50 mb-6 transition-colors hover:border-primary-400 dark:hover:border-primary-500">
          ...
          <label htmlFor="file-upload">
            <span className="cursor-pointer bg-white dark:bg-slate-700 border border-neutral-300 dark:border-slate-600 px-4 py-2 rounded-4 text-sm font-medium text-neutral-700 dark:text-slate-200 hover:bg-neutral-100 dark:hover:bg-slate-600 shadow-sm transition-colors">
              Browse Files
            </span>
          </label>
        </div>
        ...
        {file && (
          <div className="flex items-center justify-between p-4 bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800 rounded-8 mb-6">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-white dark:bg-slate-800 rounded-4 shadow-sm">
        ...
        {uploadStatus === 'success' && (
          <div className="flex items-center gap-2 text-sm text-success-700 dark:text-success-400 bg-success-50 dark:bg-success-900/30 p-4 rounded-8 border border-success-200 dark:border-success-800/50">
        ...
        {uploadStatus === 'error' && (
          <div className="text-sm text-danger-700 dark:text-danger-400 bg-danger-50 dark:bg-danger-900/30 p-4 rounded-8 border border-danger-200 dark:border-danger-800/50">
